  ...
  <footer className="w-full bg-[#050505] pt-24 pb-12 border-t border-white/5">
    <div className="max-w-[1200px] mx-auto px-6 md:px-12">
      <div className="flex flex-col items-center mb-16">
        <img src="/assets/imgs/logo.png" alt="AnyReps Logo" className="w-16 h-16 object-contain mb-4" />
      ...
      <div id="hero-section" className="max-w-[1400px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-8 relative z-10">
        ...
        <div className="space-y-8 relative z-10 order-2 lg:order-1 pt-8 lg:pt-0">
          <div className="flex items-center gap-6 animate-fade-in-up">
            <img src="/assets/imgs/logo.png" alt="Logo" className="w-16 h-16 md:w-20 md:h-20 object-contain shadow-2xl shadow-primary/20" />
